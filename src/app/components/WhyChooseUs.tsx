      ...
      <section id="features" className="relative block px-6 py-10 md:py-20 md:px-10 border-t border-b border-neutral-900 bg-neutral-900/30">
        ...
        <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-400">Customizable Menu</h3>
          ...
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-400">Fast Service</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
          ...
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
            ...
            <h3 className="mt-6 text-gray-400">Fully Equipped</h3>
            <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
